---
title: "Summary of Javascript Module Builders"
date: 2025-01-15
tags:
  - '#javascript'
  - '#module-builders'
...
### Parcel
Parcel is a zero-configuration module bundler that is easy to use and set up. It provides fast performance and is well-suited to small to medium-sized projects. It doesn’t support as many plugins as Webpack, but it is still a good option for projects that don’t need the advanced features offered by Webpack.
### Vite.js
